...
plot <- df$parks %>%
  ...
  annotate(geom = "text", x = 0, y = 125, label = "park access in Fresno has increased by 32 \npercentage points, between 2012 and 2020, \ndespite a $12 fall in spend per resident", family = "Courier", size = 2, hjust = 0, color = "#393855") +
  annotate(geom = "curve", x = 15, y = 100, xend = 40, yend = 45, curvature = .3, color = "#393855") +
  scale_x_continuous(
